(function() {
  ...
  window.Tcss = {};
  var v =
    "function" == typeof tracert &&
    "function" == typeof pgvGetColumn &&
    "function" == typeof pgvGetTopic &&
    "function" == typeof pgvGetDomainInfo &&
    "function" == typeof pgvGetRefInfo;
  if ("undefined" == typeof r) var r = 1;
  t.prototype = {
    init: function(a) {
      a ? (f = a) : (f = {});
      g = document;
      if (!f.statIframe && window != top)
        try {
          g = top.document;
        } catch (c) {}
    ...
    run: function() {
      ...
      h.save();
      this.url.unshift(
        "https://pingfore." + this.getCookieSetDomain(x) + "/pingd?"
      );
      this.url.push(this.getRefInfo(f));
      try {
        navigator.cookieEnabled
          ? this.url.push("&pvid=" + h.setCookie("pgv_pvid", !0))
      ...
      1 == A &&
        ((a = this.getParameter("tcss_rp_dm", g.URL)),
        a != Tcss.dm &&
          ((a = this.url.join("").replace(/\?dm=(.*?)\&/, "?dm=" + a + "&")),
          this.sendInfo(a)));
      f.hot &&
    ...
    getSud: function() {
      return f.sessionUserType
        ? f.sessionUserType
        : this.getParameter(f.sudParamName || "sessionUserType", g.URL);
    },
    coverCookie: function() {
      if (f.crossDomain && "on" == f.crossDomain) {
        ...
        c &&
          a &&
          ((A = 1),
          h.setCookie("ssid", !1, c),
          h.save(),
          h.setCookie("ts_refer", !0, b),
          h.setCookie("ts_last", !0, d),
          h.setCookie("pgv_pvid", !0, a));
      }
    },
    getDomainInfo: function(a) {
      ...
      x = Tcss.dm;
      w ||
        ((w = this.getCookieSetDomain(l.hostname.toLowerCase())),
    ...
    getRefInfo: function(a) {
      ...
      e = c;
      f.virtualRefDomain &&
        ("-" != c && u.push("ard=" + c), (c = f.virtualRefDomain));
      f.virtualRefURL &&
        ("-" != b && u.push("aru=" + escape(b)), (b = f.virtualRefURL));
      var k;
      a && ((k = c + b), (c = "ADTAG"), (b = a));
      p = c;
      B = escape(b);
      if ("-" == p || ("ADTAG" == p && "-" == e))
        (c = h.get("ts_last=", !0)), "-" != c && q.push("ls=" + c);
      h.setCookie(
        "ts_last",
        !0,
        escape((l.hostname + l.pathname).substring(0, 128))
      );
      c = h.get("ts_refer=", !0);
      "-" != c && q.push("rf=" + c);
      e = l.hostname;
      ...
      return k
        ? "&rdm=" +
            ...
            "&or=" +
            k
        : "&rdm=" + Tcss.rdm + "&rurl=" + Tcss.rurl + "&rarg=" + Tcss.rarg;
    },
    getMainEnvInfo: function() {
      ...
      try {
        ...
        g.language
          ? (d = g.language.toLowerCase())
          : g.browserLanguage && (d = g.browserLanguage.toLowerCase());
        h = g.javaEnabled() ? 1 : 0;
        e = g.platform;
    ...
    getExtendEnvInfo: function() {
      ...
      try {
        ...
        n.addBehavior &&
          (n.addBehavior("#default#homePage"),
          n.isHomePage(c) && (a += "&hp=Y"));
        n.addBehavior &&
          (n.addBehavior("#default#clientCaps"), (b = n.connectionType));
        a += "&ct=" + b;
      } catch (d) {
      } finally {
        return a;
    ...
    getElementPos: function(a) {
      ...
      if (document.getBoxObjectFor)
        (c = document.getBoxObjectFor(a)),
          (d = [
            c.x -
              (a.style.borderLeftWidth
                ? Math.floor(a.style.borderLeftWidth)
                : 0),
            c.y -
              (a.style.borderTopWidth ? Math.floor(a.style.borderTopWidth) : 0)
          ]);
      else {
        ...
        if (b != a)
          for (; b; )
            (d[0] += b.offsetLeft), (d[1] += b.offsetTop), (b = b.offsetParent);
        if (
          -1 < c.indexOf("opera") ||
          (-1 < c.indexOf("safari") && "absolute" == a.style.position)
        )
          (d[0] -= document.body.offsetLeft), (d[1] -= document.body.offsetTop);
      }
      for (
        b = a.parentNode ? a.parentNode : null;
        b && "BODY" != b.tagName && "HTML" != b.tagName;
    ...
    sendClick: function() {
      f.hottag &&
        (this.url.push(this.getDomainInfo(!0)),
        this.url.push("&hottag=" + escape(f.hottag)),
  ...
  window.pgvMain = function(a, c) {
    ...
    try {
      v &&
        ("undefined" != typeof pvRepeatCount && 1 == pvRepeatCount
          ? ((r = 1), (pvRepeatCount = 2))
          : (r = 2)),
        1 == r && ((r = 2), new t(b).run());
    } catch (d) {}
